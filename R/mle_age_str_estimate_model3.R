...
#=============================================================
start.time <- Sys.time()
if(!file.exists("data/processed_data/new_processed_february_2016/mle_age_str_a0_beta0ForcEstimates.RData")){ 
  ...
  mle_age_str_non_epi_seguenNonEpiForc_a0_beta0_2007 = mleYearSpecFit_age_str(district_id=1,
  ...
  mle_age_str_non_epi_seguenNonEpiForc_a0_beta0_2009 = mleYearSpecFit_age_str(district_id=1,
  ...
  mle_age_str_non_epi_seguenNonEpiForc_a0_beta0_2010 = mleYearSpecFit_age_str(district_id=1,
  ...
  mle_age_str_non_epi_houndeForc_a0_beta0_2007 = mleYearSpecFit_age_str(district_id=2,
  ...
  mle_age_str_non_epi_houndeForc_a0_beta0_2008 = mleYearSpecFit_age_str(district_id=2,
  ...
  mle_age_str_non_epi_houndeForc_a0_beta0_2009 =  mleYearSpecFit_age_str(district_id=2,
  ...
  mle_age_str_non_epi_lenaForc_a0_beta0_2007 = mleYearSpecFit_age_str(district_id=3,
  ...
  mle_age_str_non_epi_kvigueForc_a0_beta0_2008 = mleYearSpecFit_age_str(district_id=4,
  ...
  mle_age_str_non_epi_kvigueForc_a0_beta0_2010 = mleYearSpecFit_age_str(district_id=4,
  ...
  save(mle_age_str_non_epi_seguenNonEpiForc_a0_beta0_2006,
       mle_age_str_non_epi_seguenNonEpiForc_a0_beta0_2007,
       mle_age_str_non_epi_seguenNonEpiForc_a0_beta0_2009,
       mle_age_str_non_epi_seguenNonEpiForc_a0_beta0_2010,
       mle_age_str_non_epi_houndeForc_a0_beta0_2004,
       mle_age_str_non_epi_houndeForc_a0_beta0_2006,
       mle_age_str_non_epi_houndeForc_a0_beta0_2007,
       mle_age_str_non_epi_houndeForc_a0_beta0_2008,
       mle_age_str_non_epi_houndeForc_a0_beta0_2009,
       mle_age_str_non_epi_lenaForc_a0_beta0_2006,
       mle_age_str_non_epi_lenaForc_a0_beta0_2007,
       mle_age_str_non_epi_kvigueForc_a0_beta0_2008,
       mle_age_str_non_epi_kvigueForc_a0_beta0_2010,
       file="data/processed_data/new_processed_february_2016/mle_age_str_a0_beta0ForcEstimates.RData")
  
  # Model with forcing of both the transmission and invasion rate. 
  
  mle_age_str_a0_beta0_ForcEstimates_matrice = rbind(
  ...
  save(mle_age_str_a0_beta0_ForcEstimates_matrice,
       file = "data/processed_data/new_processed_february_2016/mle_age_str_a0_beta0_ForcEstimates_matrice.RData")
  
}else{
  cat("\n COSTUM MESSAGE: The file \"mle_age_str_a0_beta0_ForcEstimates.RData\" already exist \n in :",paste(getwd(),"/data/processed_data/new_processed_february_2016/", sep="/"), 
