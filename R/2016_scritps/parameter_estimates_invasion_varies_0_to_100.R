...
# Automating the setting of local working directory path relatie to the local git repository location
# in which the remote repo of the project was cloned.
#setwd(paste(getwd(),"meningoafrica-code/R",sep = "/"))
...
if(!file.exists("a0ForcEstimates.RData")){ # here we are checking in the current working directory
    ...
    seguenNonEpiForc_a0_2006 = yearSpecFit(district_id=1,
                                           ...
                                           nloptrAlgorithm = "NLOPT_LN_COBYLA",  # NLOPT_LN_BOBYQA or NLOPT_LN_COBYLA
                                           n_iter = 10000)
