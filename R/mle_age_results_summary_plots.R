...
source("R/mle_age_srt_computeModelPredictAndPerformStats.R")
...
pdf(file = paste(addSysDate("figs/final_figs/mle_age_str_hyperendemic_models_estimations_plots_updates"), 'pdf', sep = '.'),
...
#mle_age_str_a0ForcEstimates_matrice$AICc =mle_age_str_a0ForcEstimates_matrice[-c(15,29,30,54),]
...
param_to_plot_labels<-c('Mean transmission /day',
                        ...
                        'Initial susceptibles <5 years',
                        'Initial susceptibles 5-12 years',
                        'Initial susceptibles 13-19 years',
                        'Initial susceptibles 20+ years',
                        'Initial carriers <5 years',
                        'Initial carriers 5-12 years',
                        'Initial carriers 13-19 years',
                        'Initial carriers 20+ years',
