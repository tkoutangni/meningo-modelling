...
I'm happy to discuss any question you have with regard to the output.
...
if (output=="html") opts_chunk$set(fig.width=10, fig.height=8, message=FALSE, warning=FALSE, results="markup", cache = FALSE, autodep = TRUE)
...
# Part 3
### Models calibration and parameter optimisation.
